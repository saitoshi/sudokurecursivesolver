...
public class HexadecimalSudokuTest {
  ...
  public static void main(String[] arg) {
    ...
    int[][] solution4 = { { 15, 4, 13, 3, 8, 5, 10, 0, 7, 12, 1, 14, 6, 2, 9, 11},
        { 0, 12, 1, 14, 13, 6, 2, 7, 3, 9, 11, 10, 8, 4, 15, 5 },
        { 8, 5, 10, 6, 11, 14, 4, 9, 2, 0, 15, 13, 12, 1, 3, 7 },
        { 9, 7, 11, 2, 12, 1, 3, 15, 8, 5, 6, 4, 0, 10, 13, 14 },
        { 13, 8, 5, 4, 0, 15, 9, 14, 11, 3, 10, 12, 2, 6, 7, 1 },
        { 11, 0, 7, 15, 1, 12, 5, 13, 14, 2, 9, 6, 10, 3, 8, 4 },
        { 10, 6, 14, 1, 2, 7, 11, 3, 4, 13, 0, 8, 9, 15, 5, 12 },
        { 2, 3, 12, 9, 10, 4, 6, 8, 1, 15, 7, 5, 14, 11, 0, 13 },
        { 7, 1, 4, 0, 3, 9, 15, 2, 12, 10, 8, 11, 13, 5, 14, 6 },
        { 14, 15, 2, 11, 5, 8, 0, 10, 6, 4, 13, 9, 1, 7, 12, 3 },
        { 12, 10, 8, 13, 4, 11, 1, 6, 5, 14, 3, 7, 15, 0, 2, 9 },
        { 3, 9, 6, 5, 7, 13, 14, 12, 15, 1, 2, 0, 4, 8, 11, 10 },
        { 4, 14, 9, 8, 15, 2, 7, 5, 10, 6, 12, 3, 11, 13, 1, 0 },
        { 5, 2, 3, 12, 14, 10, 13, 11, 0, 8, 4, 1, 7, 9, 6, 15 },
        { 1, 13, 0, 7, 6, 3, 8, 4, 9, 11, 14, 15, 5, 12, 10, 2 },
        { 6, 11, 15, 10, 9, 0, 12, 1, 13, 7, 5, 2, 3, 14, 4, 8 } };
    
    
    //testSudoku("example 1", example1, solution1);
    //testSudoku("example 2", example2, solution2);
    //testSudoku("Hard", example3, solution3);
    testSudoku("Harder/Impossible?", example4, solution4);
  }
}